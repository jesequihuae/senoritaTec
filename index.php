            ...
            <div class="col-xs-12 col-sm-12 col-md-12 mparent">
                ...
                <div class="col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4 child epadding3">
                    <div class="form-group">
                        ...
                        <select name="NumeroJuez" class="form-control">
                            <option value="0">Escoge un juez...</option>
                            <option value="1">Juez uno</option>
                            <option value="2">Juez dos</option>
                            <option value="3">Juez tres</option>
                            <option value="4">Juez cuatro</option>
                            <option value="5">Juez cinco</option>
                        </select>
                    </div>
                    ...
                    <!--<a href="/skibooDashboard/dvskiboo/" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left"></span> Inicio</a>-->
                    <div class="row">
